    ...
    <div class="login-page">
      <div class="form">
        ...
        <!-- <form class="register-form">
          ...
          <p class="message">Sudah punya akun? <a href="#">Masuk</a></p>
        </form> -->
        <?php echo form_open_multipart(base_url("akun/masuk"),array('class' => 'form-horizontal')); ?>
        <?php echo $this->session->flashdata('error'); ?>
          ...
          <label class="message">Belum terdaftar? <a href="<?=base_url("akun/registrasi")?>">Buat Akun</a></label>
        <?php form_close(); ?>
      </div>
    </div>
  </div>
