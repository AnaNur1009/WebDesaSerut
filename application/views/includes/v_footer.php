    ...
    <div class="row">
      ...
      <div class="col-md-12 col-lg-4">
        <div class="footer-logo">
          <a class="navbar-brand" href="#">Desa Serut </a>
          <p>Serut adalah sebuah desa di wilayah Kecamatan Panti, Kabupaten Jember, Provinsi Jawa Timur.</p>
        </div>
      </div>

      <div class="col-sm-6 col-md-3 col-lg-2">
        <div class="list-menu">
          <h5 class="text-white ml-3">Contact</h5 class="text-white ml-3">
          <ul class="list-styled">
            <li><a href="<?=base_url('pengaduan/lihat/semua')?>">No.Telp</a></li>
            <li><a href="<?=base_url('pengaduan/buat_pengaduan')?>">Email</a></li>
          </ul>
        </div>
      </div>
      <div class="col-sm-6 col-md-3 col-lg-2">
