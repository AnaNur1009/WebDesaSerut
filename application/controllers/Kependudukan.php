...
class Kependudukan extends CI_Controller{
	...
	function index(){
		...
		$this->load->view('kependudukan/detail_kependudukan');
	...
	function profil(){
		$title['judul'] = 'Profil Desa';
		$this->load->view('includes/v_header', $title);
		$this->load->view('kependudukan/profil');
		$this->load->view('includes/v_footer');
	}
	...
	function pendidikan(){
		...
		$this->load->view('includes/v_header', $title);
		$this->load->view('kependudukan/v_pendidikan', $data);
		$this->load->view('includes/v_footer');
	}
	...
	function pekerjaan(){
		...
		$this->load->view('includes/v_header', $title);
		$this->load->view('kependudukan/pekerjaan',$data);
		$this->load->view('includes/v_footer');
	}
	...
	function agama(){
		...
		$this->load->view('includes/v_header', $title);
		$this->load->view('kependudukan/v_agama', $data);
		$this->load->view('includes/v_footer');
	}
	...
	function bumdes(){
		...
		$this->load->view('includes/v_header', $title);
		$this->load->view('kependudukan/v_bumdes', $data);
		$this->load->view('includes/v_footer');
	}
	...
	function detail_bumdes($id){
		...
		// print_r($data['hasil']);
		$this->load->view('includes/v_header', $title);
		$this->load->view('kependudukan/v_detail_bumdes', $data);
		$this->load->view('includes/v_footer');
	}
	...
	function detail_umkm($id){
		...
		$this->load->view('includes/v_header', $title);
		$this->load->view('kependudukan/v_detail_umkm', $data);
		$this->load->view('includes/v_footer');
	}
	...
	function detail(){
		...
		$this->load->view('includes/v_header', $title);
		$this->load->view('kependudukan/v_detail', $data);
		$this->load->view('includes/v_footer');
	}
	...
	function dana(){
		...
		$this->load->view('includes/v_header', $title);
		$this->load->view('kependudukan/v_dana', $data);
		$this->load->view('includes/v_footer');
	}
}
