...
class Struktur extends CI_Controller{
	...
	function index(){
		$title['judul'] = 'Struktur Desa';
		$title['active'] = 'desa';

		$data['desa'] = $this->m_crud->pegawai();
		$data['judul'] = 'Struktur Desa';
		$this->load->view('includes/v_header', $title);
		$this->load->view('struktur/desa', $data);
		$this->load->view('includes/v_footer');
	}

	function detail($id_pegawai){
		$title['judul'] = 'Biodata Lengkap';
		$title['active'] = 'detail';

		$data['detail'] = $this->m_crud->detail_biodata($id_pegawai);
		$data['judul'] = 'Biodata Lengkap';	
		$this->load->view('includes/v_header', $title);
		$this->load->view('struktur/detail_struktur',$data);
		$this->load->view('includes/v_footer');
	}
